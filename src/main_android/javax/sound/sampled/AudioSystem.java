...
public class AudioSystem {
    ...
    private final static String audioFileReaderPath = "META-INF/services/javax.sound.javax.sound.sampled.spi.AudioFileReader"; //$NON-NLS-1$

    private final static String audioFileWriterPath = "META-INF/services/javax.sound.javax.sound.sampled.spi.AudioFileWriter"; //$NON-NLS-1$

    private final static String formatConversionProviderPath = "META-INF/services/javax.sound.javax.sound.sampled.spi.FormatConversionProvider"; //$NON-NLS-1$

    private final static String mixerProviderPath = "META-INF/services/javax.sound.javax.sound.sampled.spi.MixerProvider"; //$NON-NLS-1$

    private final static String CLIP = "javax.sound.javax.sound.sampled.Clip"; //$NON-NLS-1$

    private final static String PORT = "javax.sound.javax.sound.sampled.Port"; //$NON-NLS-1$

    private final static String SOURCEDATALINE = "javax.sound.javax.sound.sampled.SourceDataLine"; //$NON-NLS-1$

    private final static String TARGETDATALINE = "javax.sound.javax.sound.sampled.TargetDataLine"; //$NON-NLS-1$
    ...
    private static Line getLine(String propName, Line.Info info)
        ...
        if (CLIP.equals(propName)) {
            try {
                return (Clip)(Class.forName("com.android.internal.sound.javax.sound.sampled.AndroidClip").newInstance());
            } catch (Exception ex) {
                // Ignore
            }
        }
    ...
    public static AudioInputStream getAudioInputStream(InputStream stream)
        ...
        // BEGIN android-added
        try {
            AudioFileReader reader = (AudioFileReader)(Class.forName("com.android.internal.sound.javax.sound.sampled.AndroidAudioFileReader").newInstance());
