...
public class F0PredominanceCalculatorModule 
  implements ProducerConsumerCompatible<PeakSet,TimeSeriesCompatible> {

  private F0PredominanceCalculatorFactory factory = 
    F0PredominanceCalculatorFactory.getFactory();
  private F0PredominanceCalculator f0calc;
  ...
  public F0PredominanceCalculatorModule() {
//    f0calc = factory.createCalculator(nnFrom, nnThru, step);
  }
