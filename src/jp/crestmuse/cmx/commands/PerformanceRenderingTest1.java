 ...
 * PerformanceRenderingTest1.java の 記述例も参考にしてください．
 * 
...
public class PerformanceRenderingTest1 extends CMXCommand {
	...
	protected void run() throws IOException, ParserConfigurationException,
		...
		// newOutputData() 関数を呼び出すことで，出力先outdata()を得ることができるようになります．
		// deviationXMLはDeviationInstanceWrapperクラスとして記述されます．
		// このサンプルでは，出力先 outdata() を，DeviationInstanceWrapperクラスのオブジェクト
		...
		// --------------------------------
		MusicXMLWrapper.Part[] partlist = xml.getPartList();
