...
public class PerformanceRenderingTest2 
   ...
   * 
   * <code>java jp.crestmuse.cmx.commands.PerformanceRenderingTest <i>inputfilename</i> -o[ut] <i>outputfilename</i></code>
   * 
   * @param inputfilename
  ...
  protected DeviationInstanceWrapper run(MusicXMLWrapper musicxml) 
    ...
    musicxml.processNotePartwise(new ProcessHandler());
    
    // 表情付与処理が終わったらDeviationInstanceWrapperオブジェクトに変換して、
    // returnします。
